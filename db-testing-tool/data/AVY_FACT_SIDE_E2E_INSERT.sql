...
SELECT /*+ PARALLEL(32) */
    NULL /* PDM_MISS: cannot resolve alias(es) EXG_DIM for EXG_DIM_ID -- add to PDM or correct DRD source_table */ AS EXG_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) AR_DIM for AR_DIM_ID -- add to PDM or correct DRD source_table */ AS AR_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) AR_DIM for OFST_AR_DIM_ID -- add to PDM or correct DRD source_table */ AS OFST_AR_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) ACG_TP_DIM for ACG_TP_DIM_ID -- add to PDM or correct DRD source_table */ AS ACG_TP_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) CASH_POS_TP_DIM for CASH_POS_TP_DIM_ID -- add to PDM or correct DRD source_table */ AS CASH_POS_TP_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) CCY_DIM for SBC_CCY_DIM_ID -- add to PDM or correct DRD source_table */ AS SBC_CCY_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) IMT_PD_DIM for SEC_PD_DIM_ID -- add to PDM or correct DRD source_table */ AS SEC_PD_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) IMT_PD_DIM for CASH_PD_DIM_ID -- add to PDM or correct DRD source_table */ AS CASH_PD_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) LGCY_CNCL_CMPLN_RSN_TP_DIM for LGCY_CNCL_CMPLN_RSN_DIM_ID -- add to PDM or correct DRD source_table */ AS LGCY_CNCL_CMPLN_RSN_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) LGCY_CNCL_CMPLN_SRC_TP_DIM for LGCY_CNCL_CMPLN_SRC_DIM_ID -- add to PDM or correct DRD source_table */ AS LGCY_CNCL_CMPLN_SRC_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) LGCY_MKT_TP_DIM for LGCY_MKT_TP_DIM_ID -- add to PDM or correct DRD source_table */ AS LGCY_MKT_TP_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) LGCY_TRD_CPCTY_TP_DIM for LGCY_TRD_CPCTY_TP_DIM_ID -- add to PDM or correct DRD source_table */ AS LGCY_TRD_CPCTY_TP_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) SRC_PCS_TP_DIM for SRC_PCS_TP_DIM_ID -- add to PDM or correct DRD source_table */ AS SRC_PCS_TP_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) SRC_ENTR_CNL_TP_DIM for SRC_ENTR_CNL_TP_DIM_ID -- add to PDM or correct DRD source_table */ AS SRC_ENTR_CNL_TP_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) TRD_SLCT_TP_DIM for TRD_SLCT_TP_DIM_ID -- add to PDM or correct DRD source_table */ AS TRD_SLCT_TP_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) SRC_STM_DIM for TXN_SRC_STM_DIM_ID -- add to PDM or correct DRD source_table */ AS TXN_SRC_STM_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) SRC_STM_DIM for REL_TXN_SRC_STM_DIM_ID -- add to PDM or correct DRD source_table */ AS REL_TXN_SRC_STM_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) AR_DIM for BKR_AR_DIM_ID -- add to PDM or correct DRD source_table */ AS BKR_AR_DIM_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) DATE_DIM for TD_DIM_ID -- add to PDM or correct DRD source_table */ AS TD_DIM_ID,
    TXN.TD AS TD,
    NULL /* PDM_MISS: cannot resolve alias(es) DATE_DIM for SD_DIM_ID -- add to PDM or correct DRD source_table */ AS SD_DIM_ID,
    TXN.SD AS SD,
    TXN.BKG_DT AS BKG_DT,
    TXN.ORIG_BKG_DT AS ORIG_BKG_DT,
    TXN.EXEC_DTM AS EXEC_DTM,
    TXN.TXN_ID AS TXN_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) TXN_RLTNP for REL_TXN_ID -- add to PDM or correct DRD source_table */ AS REL_TXN_ID,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) APA for SALE_CHRG_RATE_PCT -- add to PDM or correct DRD source_table */ AS SALE_CHRG_RATE_PCT,
    ...
    NULL AS CASH_AVY_TP,
    NULL /* PDM_MISS: cannot resolve alias(es) TXN_AVY_CL for CSH_AVY_CL_ID -- add to PDM or correct DRD source_table */ AS CSH_AVY_CL_ID,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) SRC_PCS_TP_DIM for SRC_PCS_TP_CD -- add to PDM or correct DRD source_table */ AS SRC_PCS_TP_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) SRC_PCS_TP_DIM for SRC_PCS_TP_NM -- add to PDM or correct DRD source_table */ AS SRC_PCS_TP_NM,
    NULL /* PDM_MISS: cannot resolve alias(es) CCY_DIM for CCY_DIM_ID -- add to PDM or correct DRD source_table */ AS CCY_DIM_ID,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) EXG_DIM for EXG_NM -- add to PDM or correct DRD source_table */ AS EXG_NM,
    NULL /* PDM_MISS: cannot resolve alias(es) ACG_TP_DIM for ACG_TP_CD -- add to PDM or correct DRD source_table */ AS ACG_TP_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) ACG_TP_DIM for ACG_TP_NM -- add to PDM or correct DRD source_table */ AS ACG_TP_NM,
    NULL /* PDM_MISS: cannot resolve alias(es) CASH_POS_TP_DIM for CASH_POS_TP_CD -- add to PDM or correct DRD source_table */ AS CASH_POS_TP_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) CASH_POS_TP_DIM for CASH_POS_TP_NM -- add to PDM or correct DRD source_table */ AS CASH_POS_TP_NM,
    NULL /* PDM_MISS: cannot resolve alias(es) LGCY_CNCL_CMPLN_RSN_TP_DIM for LGCY_CNCL_CMPLN_RSN_TP_CD -- add to PDM or correct DRD source_table */ AS LGCY_CNCL_CMPLN_RSN_TP_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) LGCY_CNCL_CMPLN_RSN_TP_DIM for LGCY_CNCL_CMPLN_RSN_TP_NM -- add to PDM or correct DRD source_table */ AS LGCY_CNCL_CMPLN_RSN_TP_NM,
    NULL /* PDM_MISS: cannot resolve alias(es) LGCY_CNCL_CMPLN_SRC_TP_DIM for LGCY_CNCL_CMPLN_SRC_TP_CD -- add to PDM or correct DRD source_table */ AS LGCY_CNCL_CMPLN_SRC_TP_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) LGCY_CNCL_CMPLN_SRC_TP_DIM for LGCY_CNCL_CMPLN_SRC_TP_NM -- add to PDM or correct DRD source_table */ AS LGCY_CNCL_CMPLN_SRC_TP_NM,
    NULL /* PDM_MISS: cannot resolve alias(es) LGCY_MKT_TP_DIM for LGCY_MKT_TP_CD -- add to PDM or correct DRD source_table */ AS LGCY_MKT_TP_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) LGCY_MKT_TP_DIM for LGCY_MKT_TP_NM -- add to PDM or correct DRD source_table */ AS LGCY_MKT_TP_NM,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) SRC_ENTR_CNL_TP_DIM for SRC_ENTR_CNL_TP_CD -- add to PDM or correct DRD source_table */ AS SRC_ENTR_CNL_TP_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) SRC_ENTR_CNL_TP_DIM for SRC_ENTR_CNL_TP_NM -- add to PDM or correct DRD source_table */ AS SRC_ENTR_CNL_TP_NM,
    NULL /* PDM_MISS: cannot resolve alias(es) TRD_SLCT_TP_DIM for TRD_SLCT_TP_CD -- add to PDM or correct DRD source_table */ AS TRD_SLCT_TP_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) TRD_SLCT_TP_DIM for TRD_SLCT_TP_NM -- add to PDM or correct DRD source_table */ AS TRD_SLCT_TP_NM,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) SRC_STM_DIM for SRC_STM_CD -- add to PDM or correct DRD source_table */ AS SRC_STM_CD,
    NULL AS BATCH_DT,
    NULL /* PDM_MISS: cannot resolve alias(es) CCAL_CIRD_PD_MAP for CASH_CIRD_PD_ID -- add to PDM or correct DRD source_table */ AS CASH_CIRD_PD_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) CCAL_CIRD_PD_MAP for SEC_CIRD_PD_ID -- add to PDM or correct DRD source_table */ AS SEC_CIRD_PD_ID,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) APA for SALE_CHRG_RATE_MULTI_NUM -- add to PDM or correct DRD source_table */ AS SALE_CHRG_RATE_MULTI_NUM,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) AR_DIM for MF_AC_NUM -- add to PDM or correct DRD source_table */ AS MF_AC_NUM,
    NULL /* PDM_MISS: cannot resolve alias(es) AR_DIM for OFST_ORIG_SRC_STM_AR_ID -- add to PDM or correct DRD source_table */ AS OFST_ORIG_SRC_STM_AR_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) AR_DIM for OFST_AR_ORIG_SRC_STM_CD -- add to PDM or correct DRD source_table */ AS OFST_AR_ORIG_SRC_STM_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) AR_DIM for OFST_AR_SETL_TP_CD -- add to PDM or correct DRD source_table */ AS OFST_AR_SETL_TP_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) AR_DIM for OFST_AR_SETL_TP_DSC -- add to PDM or correct DRD source_table */ AS OFST_AR_SETL_TP_DSC,
    NULL /* PDM_MISS: cannot resolve alias(es) AR_DIM for AR_SETL_TP_CD -- add to PDM or correct DRD source_table */ AS AR_SETL_TP_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) AR_DIM for AR_SETL_TP_DSC -- add to PDM or correct DRD source_table */ AS AR_SETL_TP_DSC,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) AR_GRP_SUBDIM for OWN_FA_NUM -- add to PDM or correct DRD source_table */ AS OWN_FA_NUM,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) TXN_RLTNP for REL_TXN_RLTNP_TP_ID -- add to PDM or correct DRD source_table */ AS REL_TXN_RLTNP_TP_ID,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) ACATS_BROKER for ACAT_CNTRA_FIRM_CLRG_ID_TP_CD -- add to PDM or correct DRD source_table */ AS ACAT_CNTRA_FIRM_CLRG_ID_TP_CD,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) CL_VAL for REL_TXN_RLTNP_TP_CD -- add to PDM or correct DRD source_table */ AS REL_TXN_RLTNP_TP_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) CL_VAL for REL_TXN_RLTNP_TP_NM -- add to PDM or correct DRD source_table */ AS REL_TXN_RLTNP_TP_NM,
    NULL /* PDM_MISS: cannot resolve alias(es) SRC_STM_DIM for SRC_STM_NM -- add to PDM or correct DRD source_table */ AS SRC_STM_NM,
    NULL /* PDM_MISS: cannot resolve alias(es) SRC_STM_DIM for REL_TXN_SRC_STM_CD -- add to PDM or correct DRD source_table */ AS REL_TXN_SRC_STM_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) SHDW_TXN_TP for SHDW_TXN_TP_NM -- add to PDM or correct DRD source_table */ AS SHDW_TXN_TP_NM,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) FA_NUMBER_V for OWN_FA_NUM_ENT_CD -- add to PDM or correct DRD source_table */ AS OWN_FA_NUM_ENT_CD,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_NUM_ENT_ENTP_ID -- add to PDM or correct DRD source_table */ AS OWN_FA_NUM_ENT_ENTP_ID,
    NULL /* PDM_MISS: cannot resolve alias(es) FIP for AGRT_ORIG_FEES -- add to PDM or correct DRD source_table */ AS AGRT_ORIG_FEES,
    NULL /* PDM_MISS: cannot resolve alias(es) FIP for AGRT_STMT_FEES -- add to PDM or correct DRD source_table */ AS AGRT_STMT_FEES,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) TXN_SRC_TAX_CODE_LKUP for TXN_SRC_TAX_CD -- add to PDM or correct DRD source_table */ AS TXN_SRC_TAX_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) TXN_SRC_TAX_CODE_LKUP for TXN_SRC_TAX_CD_DSC -- add to PDM or correct DRD source_table */ AS TXN_SRC_TAX_CD_DSC,
    TXN.TM_PRC_DISCRETION_F AS TM_PRC_DISCRETION_F,
    NULL /* PDM_MISS: cannot resolve alias(es) TXN_AVY_CL for CASH_NNA_CGY_ID -- add to PDM or correct DRD source_table */ AS CASH_NNA_CGY_ID,
    NULL AS CASH_NNA_CGY_NM,
    NULL /* PDM_MISS: cannot resolve alias(es) TXN_AVY_CL for SCR_NNA_CGY_ID -- add to PDM or correct DRD source_table */ AS SCR_NNA_CGY_ID,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) FA_NUMBER_V for OWN_PRIM_FA_NUM -- add to PDM or correct DRD source_table */ AS OWN_PRIM_FA_NUM,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_BR_CD -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_BR_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_BSN_ST -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_BSN_ST,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_DIV_CD -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_DIV_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_DIV_DSC -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_DIV_DSC,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_DIV_NODE -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_DIV_NODE,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_MAIN_BR_STE -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_MAIN_BR_STE,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_OSJ -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_OSJ,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_SUBDIV_CD -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_SUBDIV_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_SUBDIV_DSC -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_SUBDIV_DSC,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_SUBS -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_SUBS,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_SBTP -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_SBTP,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_SBTP_CD -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_SBTP_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_TP -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_TP,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_TP_CD -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_TP_CD,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_LOB_BSN_MODL -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_LOB_BSN_MODL,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_BSN_OPN_DT -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_BSN_OPN_DT,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_LONG_CD -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_LONG_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_SHRT_CD -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_SHRT_CD,
    NULL /* PDM_MISS: cannot resolve alias(es) ENTERPRISE_ENTITY_DIM_V for OWN_FA_ENT_CSS_ID -- add to PDM or correct DRD source_table */ AS OWN_FA_ENT_CSS_ID,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) APA for PD_CMPOS_DSC -- add to PDM or correct DRD source_table */ AS PD_CMPOS_DSC,
    ...
    NULL /* PDM_MISS: cannot resolve alias(es) FA_NUMBER_V for OWN_FA_NUM_TP_CD -- add to PDM or correct DRD source_table */ AS OWN_FA_NUM_TP_CD,
