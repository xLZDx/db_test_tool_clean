...
SELECT /*+ PARALLEL(32) */
    ...
    CL_VAL_1.SALE_CHRG_RATE AS SALE_CHRG_RATE_PCT,
    APA.SALE_CHRG_RATE_TP_ID AS SALE_CHRG_RATE_TP_ID,
    CL_VAL_1.CL_VAL_CODE AS SALE_CHRG_RATE_TP_CD,
    ...
    CL_VAL_6.CL_VAL_CODE AS CASH_DB_CR_CD,
    CL_VAL_1.CL_VAL_CODE AS SEC_DB_CR_CD,
    ...
    CL_VAL_1.CL_VAL_CODE AS TXN_TP_CD,
    CL_VAL_1.CL_VAL_NM AS TXN_TP_NM,
    CL_VAL_1.DSC AS TXN_TP_DSC,
    TXN.TXN_SBTP_ID AS TXN_SBTP_ID,
    CL_VAL_1.CL_VAL_NM AS TXN_SUB_TP_NM,
    CL_VAL_1.CL_VAL_CODE AS TXN_SUB_TP_CD,
    CL_VAL_1.DSC AS TXN_SUB_TP_DSC,
    TXN.EXEC_TP_ID AS EXEC_TP_ID,
    CL_VAL_1.CL_VAL_CODE AS EXEC_TP_CD,
    CL_VAL_1.CL_VAL_NM AS EXEC_TP_NM,
    CL_VAL_1.DSC AS EXEC_TP_DSC,
    CL_VAL_10.CL_VAL_CODE AS EXEC_SBTP_CD,
    CL_VAL_1.CL_VAL_NM AS EXEC_SBTP_NM,
    CL_VAL_11.DSC AS EXEC_SBTP_DSC,
    ...
    CL_VAL_8.CL_VAL_CODE AS DOL_IND_CD,
    CL_VAL_9.CL_VAL_NM AS DOL_IND_NM,
    ...
    CL_VAL_1.CL_VAL_NM AS SALE_CHRG_RATE_TP_NM,
    CL_VAL_7.CL_VAL_NM AS CASH_DB_CR_NM,
    CL_VAL_1.CL_VAL_NM AS SEC_DB_CR_NM,
    ...
    CL_VAL_1.CL_VAL_CODE AS OMS_EXEC_TP_CD,
    CL_VAL_1.CL_VAL_NM AS OMS_EXEC_TP_NM,
    CL_VAL_1.DSC AS OMS_EXEC_TP_DSC,
    ...
    CL_VAL_1.SALE_CHRG_RATE AS SALE_CHRG_RATE_MULTI_NUM,
    ...
    CL_VAL_1.CL_VAL_NM AS SIS_DLTD_EV_NM,
    CL_VAL_2.CL_VAL_CODE AS SRC_CNCL_RSN_CD,
    CL_VAL_3.CL_VAL_NM AS SRC_CNCL_RSN_NM,
    CL_VAL_4.CL_VAL_CODE AS TXN_RCNCL_ST_CD,
    CL_VAL_5.CL_VAL_NM AS TXN_RCNCL_ST_NM,
    ...
    CL_VAL_1.CL_VAL_CODE AS SIS_DLTD_EV_CD,
    ...
    AR_DIM_1.ENTITY_RJAS_ID_BOOLEAN AS OWN_FA_ENT_RJAS_ID_F,
    ...
    AR_DIM_1.LOB_ALEX_BROWN_BOOLEAN AS OWN_FA_ENT_LOB_AB_F,
    AR_DIM_1.LOB_AMS_BOOLEAN AS OWN_FA_ENT_LOB_AMS_F,
