...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--target-table", required=True, help="Real target table, e.g. TARGET_OWNER.TARGET_FACT")
    p.add_argument("--control-table", required=True, help="Control table created by generated insert, e.g. CONTROL_OWNER.TARGET_FACT")
