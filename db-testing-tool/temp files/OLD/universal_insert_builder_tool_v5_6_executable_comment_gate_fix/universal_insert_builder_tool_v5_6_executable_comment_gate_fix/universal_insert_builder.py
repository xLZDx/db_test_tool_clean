...
__VERSION__ = "5.6-executable-comment-gate-fix"
...
def run(args):
    ...
    summary = {
        ...
        **tri_summary,
        "note": "v5.6: generated SQL is DRD-driven and executable SQL is hard-scrubbed/gated for residual comment markers. SDIRA_TXN_TP_CD is parsed directly from TXN.TRD_NUM; SDIRA_TXN_TP is resolved through CL_VAL_CODE. Cancellation flag is strict DRD. ODI XML is evidence only and is not emitted into the SQL body."
    }
